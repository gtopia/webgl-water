...
Renderer.prototype.updateCaustics = function(gl, water) {
...
Renderer.prototype.renderWater = function(GL, gl, water, sky) {
...
Renderer.prototype.renderCube = function(gl, water) {
  gl.enable(gl.CULL_FACE);
  water.textureA.bind(0);
  this.tileTexture.bind(1);
