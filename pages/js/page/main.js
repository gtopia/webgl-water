...
require('../lib/OES_texture_float_linear-polyfill.js');

var GL = require('../lib/lightgl.js');
var Water = require('../mods/common/water.js');
var Renderer = require('../mods/common/renderer.js');
var Cubemap = require('../mods/common/cubemap.js');
...
window.onload = function() {
            ...
            case MODE_ADD_DROPS:
                {
                    ...
                    if (paused) {
                        water.updateNormals();
                        renderer.updateCaustics(gl, water);
                    }
                    break;
                }
            case MODE_MOVE_SPHERE:
                {
                    ...
                    prevHit = nextHit;
                    if (paused) renderer.updateCaustics(gl, water);
                    break;
                }
    ...
    function draw() {
        ...
        renderer.renderCube(gl, water);
        renderer.renderWater(GL, gl, water, cubemap);
